...
/*   Updated: 2021/08/22 20:07:39 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(void):
name("n/a"), gradeSign(1), gradeExec(1), sign(false)
{
}

Form::Form(std::string name, int gradeSign, int gradeExec):
name(name), gradeSign(checkGrade(gradeSign)), gradeExec(checkGrade(gradeExec)), sign(false)
{
}

Form::Form(const Form & c):
name(c.name), gradeSign(c.gradeSign), gradeExec(c.gradeExec), sign(c.sign)
{	
}
